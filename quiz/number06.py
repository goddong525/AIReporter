...
softmax = tf.keras.models.load_model('../models/softmax.h5')
dense = tf.keras.models.load_model('../models/dense.h5')
embedding = tf.keras.models.load_model('../models/embedding.h5')
